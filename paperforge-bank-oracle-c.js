/* 🏭 PAPERFORGE S6 — ORACLE C · GATE 2027 prophecy (AI-GENERATED · seeded 2703)
   Minted by _audit/paperforge/forge_oracle.js — do not hand-edit. */
window.FORGE_BANKS = window.FORGE_BANKS || {};
window.FORGE_BANKS["pf-oracle-c"] = {
 "id": "pf-oracle-c",
 "label": "🔮 PAPERFORGE — ORACLE C · GATE 2027 prophecy (blueprint-weighted)",
 "series": "PAPERFORGE",
 "stage": "S6",
 "seed": 2703,
 "minted": "2026-08-18",
 "aiGenerated": true,
 "note": "AI-GENERATED prophecy paper — blueprint-weighted assembly over audited forge legions (seed 2703, log: _audit/paperforge/oracle_assembly_log.md). GA set freshly authored for this paper. Official GATE pattern: 65 Q · 100 marks · 3 h · MCQ −1/3 · −2/3, MSQ & NAT no negative.",
 "durationSec": 10800,
 "totalQ": 65,
 "maxScore": 100,
 "figCount": 4,
 ...
 "questions": [
  {
   ...
   "ans": 1,
   "sol": "EPHEMERAL means lasting a very short time — short-lived (from the mayfly genus Ephemera). Eternal is the antonym.",
   "tags": [
    "synonym"
   ],
   "srcId": "PF-GA-C1",
   "srcBank": "pf-oracle-ga-c",
   "part": "GA",
   "correctMarks": 1,
   "wrongMarks": 0.333,
   "code": "GA"
  },
  {
   ...
   "ans": 1,
   "sol": "With “neither … nor”, the verb agrees with the nearer subject; “the students” is plural, so “were”.",
   "tags": [
    "proximity-agreement"
   ],
   "srcId": "PF-GA-C2",
  ...
  },
  {
   ...
   "opts": [
    "to strike hard in anger",
    "to say exactly the right thing",
    "to finish work ahead of time",
    "to take an unnecessary risk"
   ],
   "ans": 1,
   "sol": "The idiom means describing a situation or answer with perfect accuracy — saying exactly the right thing.",
   "tags": [
    "idiom"
   ],
   "srcId": "PF-GA-C3",
  ...
  },
  {
   ...
   "ans": 2,
   "sol": "Each term doubles the previous and subtracts $1$: $2\\to3\\to5\\to9\\to17$, so $17\\times2-1=33$. (Equivalently gaps double: $+1,+2,+4,+8$, then $+16$.)",
   "tags": [
    "series"
   ],
   "srcId": "PF-GA-C4",
  ...
  },
  {
   ...
   "ans": 0,
   "sol": "Professional-to-served-person relation: a doctor serves a patient as a lawyer serves a client.",
   "tags": [
    "analogy"
   ],
   "srcId": "PF-GA-C5",
  ...
  },
  {
   ...
   "ans": 1,
   "sol": "Equal distances take the harmonic mean: $\\bar v=2\\times60\\times40/(60+40)=4800/100=48\\,\\mathrm{km/h}$, not the arithmetic $50$.",
   "tags": [
    "average-speed"
   ],
   "srcId": "PF-GA-C6",
  ...
  },
  {
   ...
   "ans": 1,
   "sol": "$x-0.25x=45$ gives $0.75x=45$, so $x=60$. ($25\\%$ of $60$ is $15$, and $60-15=45$ ✓.)",
   "tags": [
    "percentage"
   ],
   "srcId": "PF-GA-C7",
  ...
  },
  {
   ...
   "ans": 1,
   "sol": "$\\binom{5}{2}\\times\\binom{4}{1}=10\\times4=40$. ($84=\\binom{9}{3}$ ignores the gender condition.)",
   "tags": [
    "combinations"
   ],
   "srcId": "PF-GA-C8",
  ...
  },
  {
   ...
   "ans": 1,
   "sol": "$|30H-5.5M|=|180-165|=15^\\circ$: the hour hand has drifted halfway from $6$ to $7$.",
   "tags": [
    "clock-angle"
   ],
   "srcId": "PF-GA-C9",
  ...
  },
  {
   ...
   "ans": 1,
   "sol": "$\\sum k^2=n(n+1)(2n+1)/6$ with $n=10$: $10\\times11\\times21/6=2310/6=385$.",
   "tags": [
    "square-sum"
   ],
   "srcId": "PF-GA-C10",
